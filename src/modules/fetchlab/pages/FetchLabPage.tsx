  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <div className="flex items-stretch bg-surface-950 border-b border-surface-700/60 flex-shrink-0 min-h-[36px]">
          {/* Scrollable tabs */}
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isActive
                        ? 'bg-surface-900 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-brand-500'
          ...
          <div className="flex items-center border-l border-surface-700/40 flex-shrink-0">
            <button
              ...
              className="group relative flex items-center justify-center w-9 h-full text-surface-500 hover:text-white hover:bg-surface-800/60 transition-colors"
            >
              <Settings size={13} />
              <span className="pointer-events-none absolute top-full mt-1.5 right-0 text-[10px] bg-surface-800 border border-surface-700 text-slate-200 px-2 py-0.5 rounded shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity z-50">
                Environment
              </span>
            </button>
            <button
              ...
              className="group relative flex items-center justify-center w-9 h-full text-surface-500 hover:text-white hover:bg-surface-800/60 transition-colors disabled:opacity-30 disabled:pointer-events-none"
            >
              <Code2 size={13} />
              <span className="pointer-events-none absolute top-full mt-1.5 right-0 text-[10px] bg-surface-800 border border-surface-700 text-slate-200 px-2 py-0.5 rounded shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity z-50">
                Code Snippet
        ...
        {/* ── URL bar ── */}
        <div className="border-b border-surface-700/60 flex-shrink-0">
          <FetchLabRequestBar />
        </div>
        ...
        <div
          ...
          className="flex-shrink-0 flex items-center justify-center h-2 cursor-row-resize bg-surface-800 hover:bg-brand-600/20 transition-colors group z-10 flex-shrink-0 border-b border-surface-700/40"
